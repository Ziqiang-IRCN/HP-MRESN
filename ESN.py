...
class ESN(Module):
    ...
    def __init__(self,input,reservoir,sr,scale_in,leaking_rate,density,Nepochs=None,eta=None,mu=None,sigma=None,threshold=None,
    ...
    def forward(self,input,h_0=None,useIP = False, IPmode = 'training'):
    ...
    def extra_repr(self) -> str:
        return 'input_dim={}, res_dim={}, spectral_radius={}, res_density = {}, in_scale = {}, leaking_rate = {}'.format(
            self.input, self.reservoir, self.spectral_radius, self.density, self.scale_in, self.leaking_rate)
